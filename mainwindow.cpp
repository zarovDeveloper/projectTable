    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->pushButton_saveBin->setVisible(false);
    ui->pushButton_openBin->setVisible(false);
...
/* Контрольная сумма считается как size * tmp(i) */
